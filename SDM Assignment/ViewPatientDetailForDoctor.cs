...
namespace SDM_Assignment
{
    public partial class PatientDetail : UserControl
    {
        ...
        {
            InitializeComponent();
            viewPatientRecordForDoctor.Hide();
            viewPatientRecordForDoctor.buttonBack.Click += new EventHandler(viewPatientRecordForDoctorButtonBack_Click);
        }

        public void updatePatientDetailForDoctor(int patientId, int doctorId)
        {
        ...
        {
            viewPatientRecordForDoctor.updateListViewListPatientRecord(formPatientId, formDoctorId);
            viewPatientRecordForDoctor.Show();
        }

        private void viewPatientRecordForDoctorButtonBack_Click(object sender, EventArgs e)
        {
            updatePatientDetailForDoctor(formPatientId, formDoctorId);
            viewPatientRecordForDoctor.Hide();
        }
    }
}
